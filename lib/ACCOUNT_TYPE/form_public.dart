...
class FormfillPublic extends StatefulWidget {
  ...
  @override
  State<FormfillPublic> createState() => _FormfillPublicState();
}

class _FormfillPublicState extends State<FormfillPublic> {
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: TextFormField(
                      ...
                      decoration:
                          buildInputdecoration('Enter Your Name or Comuunity'),
                    ),
                  ),
                  sizedbox(),
                  SizedBox(
