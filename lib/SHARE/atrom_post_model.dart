...
class Datum {
    ...
    factory Datum.fromJson(Map<String, dynamic> json) => Datum(
        ...
        sharedCaption: json["shared_caption"],
        ownerPostId: json["owner_post_id"],
        pageId: json["page_id"],
        ...
        tagmembers: json["tagmembers"],
        sharePostId: json["share_postId"],
        ...
        shareProfile: json["share_profile"],
        shareroleid: json["shareroleid"],
        ...
        ownerChainOfLove: json["owner_chain_of_love"],
        ownerPage: json["owner_page"],
        ownerAtromg8: json["owner_atromg8"],
        ownerAssociation: json["owner_association"],
        ownerCompany: json["owner_company"],
        shareDataCaption: json["shareData_caption"],
        shareDataMedia: json["shareData_media"],
        shareDataMediaType: json["shareData_media_type"],
    ...
    Map<String, dynamic> toJson() => {
        ...
        "owner_chain_of_love": ownerChainOfLove,
        "owner_page": ownerPage,
        "owner_atromg8": ownerAtromg8,
        "owner_association": ownerAssociation,
        "owner_company": ownerCompany,
        "shareData_caption": shareDataCaption,
        "shareData_media": shareDataMedia,
        "shareData_media_type": shareDataMediaType,
