                                                                ...
                                                                Padding(
                                                                    ...
                                                                    child: Column(
                                                                        ...
                                                                        children: [
                                                                                ...
                                                                                children: [
                                                                                  ...
                                                                                  Column(
                                                                                    ...
                                                                                    children: [
                                                                                      Text(
                                                                                        '@Profile.Username007',
                                                                                        style: TextStyle(color: primaryColorOfApp, fontFamily: 'Poppins', fontSize: MediaQuery.of(context).size.height > 667 ? 10.sp : 12.sp),
                                                                                      ),
                                                                                      Text(
                                                                                        'Ajay Singh-B',
                                                                                        style: ProfileSelf().buildtextstyle(),
                                                                          ...
                                                                          Row(
                                                                            children: [
                                                                              Text('@Profile.Username007',
                                                                                  style: TextStyle(
                                                                                    fontFamily: 'Poppins',
                                                                                    color: primaryColorOfApp,
                                                                                    fontSize: MediaQuery.of(context).size.height > 667 ? 10.sp : 12.sp,
                                                                                  )),
                                                                              SizedBox(
                                                                                width: 1.w,
                                                                              ),
                                                                          ...
                                                                          Row(
                                                                            children: [
                                                                              Text('26 December 2022 at 10:56am',
                                                                                  style: TextStyle(
                                                                                    fontFamily: 'Poppins',
                                                                                    color: customTextColor,
                                                                                    fontSize: MediaQuery.of(context).size.height > 667 ? 8.sp : 10.sp,
                                                                                  )),
                                                                              SizedBox(
                                                                                width: 4.w,
                                                                              ),
                                                                          ...
                                                                          SizedBox(
                                                                              height: 6.h,
                                                                              width: double.infinity,
                                                                              child: ElevatedButton(style: ElevatedButton.styleFrom(elevation: 0, backgroundColor: const Color(0xff0087FF), shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10.0))), onPressed: () {}, child: const Text('Confirm', style: TextStyle(color: Colors.white, fontSize: 15, fontFamily: 'Poppins')))),
                                                                          SizedBox(
                                                                            height:
                                                                                6.h,
                                                                          ),
